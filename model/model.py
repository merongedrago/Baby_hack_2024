            ...
            for bbox in result.boxes:  # Get bounding boxes
                ...
                if conf > conf_threshold:  # Filter by confidence
                    ...
                    if model.names[cls] == 'person':
                        ...
                        expand_x = normalized_x - ((expand_width - normalized_width) / 2)
                        expand_y = normalized_y - ((expand_height - normalized_height) / 2)
                    ...
                    output_matrix.append({
                        'frame': int(cap.get(cv2.CAP_PROP_POS_FRAMES)),  # Current frame number
                    ...
                    cv2.rectangle(frame,
                                ...
                                (int((norm_x + norm_width) * frame_width), int((norm_y + norm_height) * frame_height)),
                                color, 2)
